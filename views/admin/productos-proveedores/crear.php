...
<div class="contenedor">
    ...
    <form method="POST" class="formulario">
        ...
        <fieldset class="formulario__fieldset">
            ...
            <div class="formulario__campo">
                <label for="pesoNuevo" class="formulario__label">Peso</label>
                <input type="number" step="any" id="pesoNuevo" name="pesoNuevo" class="formulario__input" placeholder='Ej. 5' value="<?php echo $peso->pesoNuevo; ?>">
            </div>
